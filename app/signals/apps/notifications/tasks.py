...
@app.task
def send_notification(municipality_code: str, payload: dict, notification_type: str) -> None:
    ...
    try:
        ...
        logging.info(f"Sending notification with payload {payload} went wrong: {e}")