...
SECURE_HSTS_INCLUDE_SUBDOMAINS: bool = os.getenv('SECURE_HSTS_INCLUDE_SUBDOMAINS', False) in TRUE_VALUES
SECURE_HSTS_PRELOAD: bool = os.getenv('SECURE_HSTS_PRELOAD', False) in TRUE_VALUES
